...
import 'package:swiggy/views/ordertrackingscreen/components/widgets.dart';
...
class OrderTrackScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: TitleAppBar('Track your Orders'),
...
_OrderInfo _data(int id) => _OrderInfo(
      ...
      deliveryProcesses: [
        _DeliveryProcess(
          ...
          messages: [
            _DeliveryMessage('8:30am', 'Food picked by rider'),
            _DeliveryMessage('9:00am', 'Reached halfway mark'),
          ],
        ),
        _DeliveryProcess(
          "On the Way",
          messages: [
            _DeliveryMessage('9:20pm', 'Rider arrived at destination'),
            _DeliveryMessage('11:35am', 'Food delivered by Rajesh'),
          ],
        ),
